...
#     it 'decreases the quality of normal items by 1' do
#       items = [Item.new('Normal item', 10, 10)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].quality).to eq(9)
#     end

#     it 'never sets the quality of a normal item to a negative value' do
#       items = [Item.new('Normal item', 10, 0)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].quality).to eq(0)
#     end

#     it 'does not change the quality of Aged Brie items' do
#       items = [Item.new('Aged Brie', 10, 10)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].quality).to eq(10)
#     end
    
#     it 'does not change the quality of Backstage Passes items' do
#       items = [Item.new('Backstage passes to a TAFKAL80ETC concert', 10, 10)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].quality).to eq(10)
#     end
    
#     it 'decreases the sell_in of normal items by 1' do
#       items = [Item.new('Normal item', 10, 10)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].sell_in).to eq(9)
#     end
    
#     it 'decreases the quality of normal items by 2 when sell_in is negative' do
...
#     it 'never sets the quality of a normal item to a value greater than 50' do
#       items = [Item.new('Normal item', 10, 51)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].quality).to eq(50)
#     end

#     it 'does not change the quality of Sulfuras items' do
...
#     it 'decreases the quality of conjured items by 4 when sell_in is negative' do
...
#   describe '#update_special_quality' do
#     it 'increases the quality of Aged Brie items by 1' do
#       items = [Item.new('Aged Brie', 10, 10)]
#       GildedRose.new(items).update_normal_quality()
#       expect(items[0].quality).to eq(11)
#     end
